       ...
       new MaterialDialog.Builder(getActivity())
                ...
                .input("playlist name", title, new MaterialDialog.InputCallback() {
                            ...
                            public void onInput(MaterialDialog dialog, CharSequence input) {
                                ...
                                if (idNewPlayList != -1) {
                                    Snackbar.make(getView(), "Playlist " + input.toString() + " "+getString(R.string.playlist_created_ok) + String.valueOf(idNewPlayList), Snackbar.LENGTH_LONG).show();
                                   // new LoaderRecycleAsynk<PlayList>(getActivity(), LoaderRecycleAsynk.Type.PLAYLIST, fastScroller, r).execute();
                                } else
                                    Snackbar.make(getView(), getString(R.string.playlist_create_err) + String.valueOf(idNewPlayList), Snackbar.LENGTH_LONG).show();
                            }
                        }
