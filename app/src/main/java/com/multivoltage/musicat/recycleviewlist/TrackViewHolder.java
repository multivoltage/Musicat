...
import com.multivoltage.musicat.entity.GoogleCoverLoader;
import com.multivoltage.musicat.entity.ImageWebAdapterDialog;
...
public class TrackViewHolder extends AGenericViewHolder<Track> {
    ...
    protected void menuItemChosed(MenuItem menuItem,Track track) {
        switch (menuItem.getItemId()){
            ...
            case R.id.shareTrack:           shareTrack(track);
                break;
            case R.id.fetchArt:     new FetchWebImagesAsynk(mContext,track).execute();
                break;
        }
    ...
    private void shareTrack(Track track){
        ...
        sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, mContext.getString(R.string.listen_this_song_share));
        ...
        new MaterialDialog.Builder(mContext)
                ...
                .itemsCallback(new MaterialDialog.ListCallback() {
                    ...
                    public void onSelection(MaterialDialog materialDialog, View view, int i, CharSequence charSequence) {
                        ...
                        if (res != -1)
                            ...
                            Snackbar.make(itemView, mContext.getString(R.string.playlist_create_err), Snackbar.LENGTH_LONG).show();
                    }
                })
                .neutralText(mContext.getString(R.string.create_new_playlist))
                .callback(new MaterialDialog.ButtonCallback() {
                    ...
                    public void onNeutral(MaterialDialog dialog) {
                        ...
                        new MaterialDialog.Builder(mContext)
                                .theme(Theme.LIGHT)
                                .title(mContext.getString(R.string.create_new_playlist))
                                ...
                                .input("Insert name", "My playlist", new MaterialDialog.InputCallback() {
                                    ...
                                    public void onInput(MaterialDialog materialDialog, CharSequence titlePlayList) {
                                        ...
                                        if (newIdPlayLIst != -1) {
                                            ...
                                            if (res != -1) {
                                                Snackbar.make(itemView, mContext.getString(R.string.added)+" " + track.getTitle() + " to " + newPlayList, Snackbar.LENGTH_LONG).show();
    ...
    class FetchWebImagesAsynk extends AsyncTask<Void,Void,List<Item>> {
        ...
        protected void onPreExecute() {
            dialog.setMessage(mContext.getString(R.string.searching_images));
            dialog.show();
        }
        @Override
        ...
        protected void onPostExecute(final List<Item> list){
            ...
            new MaterialDialog.Builder(mContext)
                    ...
                    .title(mContext.getString(R.string.chose_one_pictures))
                        ...
                        public void onSelection(final MaterialDialog materialDialog, View view, int i, CharSequence charSequence) {
                            ...
                            client.get(list.get(i).getLink(), new FileAsyncHttpResponseHandler(context) {
                                ...
                                public void onFailure(int statusCode, Header[] headers, Throwable throwable, File file) {
                                    Snackbar.make(itemView,mContext.getString(R.string.error_fetch_cov), Snackbar.LENGTH_LONG).show();
                                ...
                                public void onSuccess(int statusCode, Header[] headers, File file) {
                                    if (statusCode == 200 && file.exists()) {
                                        ...
                                        try {
                                            ...
                                            Snackbar.make(itemView,mContext.getString(R.string.edit_cover_ok),Snackbar.LENGTH_SHORT).show();
                                        } catch (IOException e) {
                                            Log.e(MainActivity.TAG, e.toString());
                                            Snackbar.make(itemView, "Error", Snackbar.LENGTH_LONG);
                                        }
                                    }
                                    materialDialog.dismiss();
                                }
