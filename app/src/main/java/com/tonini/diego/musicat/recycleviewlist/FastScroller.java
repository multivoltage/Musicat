...
import com.tonini.diego.musicat.custom.MyAutoFitTextView;
import com.tonini.diego.musicat.entity.Item;

/**
 * Created by Diego on 30/07/2015.
 */
public class FastScroller extends LinearLayout {
    ...
    private static final int HANDLE_HIDE_DELAY = 5000;
        ...
        public void onScrolled(RecyclerView rv, int dx, int dy) {
            ...
            if(position==-1){
               handle.setText("?");
                ...
                Item item = (Item) ((AGenericAdapterRecycle<Item>) recyclerView.getAdapter()).getItem(position);
                if(item!=null)
                    handle.setText(item.getFirstTitle().substring(0, 1));
                else
                    handle.setText("?");
            }
        }
